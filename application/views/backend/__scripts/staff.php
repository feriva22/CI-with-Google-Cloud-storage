...
$(document).ready(function() {
    ...
    var url = {
        data : base_url+'backend/staff/get_datatable',
        detail : base_url+'backend/staff/detail',
        add: base_url + 'backend/staff/add',
		edit: base_url + 'backend/staff/edit',
		delete: base_url + 'backend/staff/delete',
    };

    var dataTableObj = $("#staff_table").DataTable({
        processing:true,
        serverSide:true,
    ...
    page_click('.edit_act',(e)=>{
        show_detail('edit',url,get_row_dataid('stf_id',e),true);
    });
